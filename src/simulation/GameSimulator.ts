...
export class GameSimulator extends SimulationCore {
  ...
  private encodeFrame(frameIdx: number): void {
    this.video.renderFrame({
      ...
      castingTeam: this.effects.castingTeam,
      ...
      weaponChargeA: this.weapons.chargeA,
      weaponChargeB: this.weapons.chargeB,
    }, {
      ...
      weaponA:  this.teamA.weapon,
      weaponB:  this.teamB.weapon,
      timerFracA: this.getAbilityTimerFrac('A'),
      timerFracB: this.getAbilityTimerFrac('B'),
    });
